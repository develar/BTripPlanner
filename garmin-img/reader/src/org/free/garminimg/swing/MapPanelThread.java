  ...
  private void paintMap(Graphics2D g2, MapConfig workConfig, MapTransformer<COORD> workTransformer) {
    ...
    try {
      ...
      if (workConfig.wantShading() && workConfig.getQuality() == MapConfig.Quality.FINAL) {
        ReliefDrawer<COORD> reliefDrawer = new ReliefDrawer<>(workConfig, g2, workTransformer);
        MapListener drawerConverter = new CoordinateConverterListener<>(workTransformer,
                                                                        new ClippingMapListener(0, workTransformer.getWidth(), 0, workTransformer.getHeight(),
                                                                                                drawer));
        MapListener reliefConverter = new CoordinateConverterListener<>(workTransformer,
                                                                        new ClippingMapListener(0, workTransformer.getWidth(), 0, workTransformer.getHeight(),
                                                                                                reliefDrawer));
        ...
        MapListener converter = new CoordinateConverterListener<>(workTransformer,
                                                                  new ClippingMapListener(0, workTransformer.getWidth(), 0, workTransformer.getHeight(),
                                                                                          drawer));
