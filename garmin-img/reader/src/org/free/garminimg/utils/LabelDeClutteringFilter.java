...
public class LabelDeClutteringFilter {
  ...
  private SortedSet<LabelInfo> everyLabels = new TreeSet<>();

  private SortedSet<String> knownNames = new TreeSet<>();

  private ArrayList<LabelInfo> toPaintLabels = new ArrayList<>();
  ...
  public void paint() {
    ...
    g2.setFont(font);
    for (LabelInfo info : toPaintLabels) {
