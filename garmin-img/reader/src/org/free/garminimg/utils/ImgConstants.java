...
public abstract class ImgConstants {
  ...
  public static PolylineDescription getPolylineType(int type) {
    ...
    if (result == null) {
      result = new PolylineDescription(type, Integer.toString(type), false, Color.ORANGE, new java.awt.BasicStroke(1.0f), 255);
  ...
  private static final Stroke trailStroke = new java.awt.BasicStroke(0.5f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER,
                                                                     10.0f, smallDash, 0.0f);

  private static final Stroke powerLineStroke = new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER,
  ...
  private static final Object POLYLINE_TYPES_T[][] = {
    ...
    {0x01, "Major highway", Color.BLACK, new java.awt.BasicStroke(2.0f)},
    {0x02, "Principal highway", Color.BLACK, new java.awt.BasicStroke(2.0f)},
    {0x03, "Other highway", Color.BLACK, new java.awt.BasicStroke(2.0f)},
    {0x04, "Arterial road", Color.BLACK, new java.awt.BasicStroke(2.0f)},
    {0x05, "Collector road", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x06, "Residential street", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x07, "Alley/Private road", Color.BLACK, new java.awt.BasicStroke(0.5f)},
    {0x08, "Highway ramp, low speed", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x09, "Highway ramp, high speed", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x0a, "Unnpaved road", Color.BLACK, new java.awt.BasicStroke(0.5f)},
    {0x0b, "Major highway connector", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x0c, "Roundabout", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x14, "Railroad", Color.BLACK, new RailStroke(7f, 5f, 1f)},
    {0x15, "Shoreline", new Color(128, 64, 0), new java.awt.BasicStroke(1.0f)},
    {0x16, "Trail", Color.BLACK, trailStroke},
    {0x18, "Stream", water, new java.awt.BasicStroke(1.0f)},
    {0x19, "Time zone", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x1a, "Ferry", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x1b, "Ferry", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x1c, "State/province border", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x1d, "County/parish border", Color.BLACK, new java.awt.BasicStroke(1.0f)},
    {0x1e, "International border", Color.BLACK, new InternationalBorderStroke(10f, 6f, 1.5f)},
    {0x1f, "River", water, new java.awt.BasicStroke(2.0f)},
    {MINOR_LAND_CONTOUR = 0x20, "Minor land contour", new Color(128, 64, 0), new java.awt.BasicStroke(0.2f), false},
    {INTERMEDIATE_LAND_CONTOUR = 0x21, "Intermediate land contour", new Color(128, 64, 0), new java.awt.BasicStroke(0.2f), false},
    {MAJOR_LAND_CONTOUR = 0x22, "Major land contour", new Color(128, 64, 0), new java.awt.BasicStroke(0.5f), false},
    {MINOR_DEPTH_CONTOUR = 0x23, "Minor deph contour", Color.BLUE, new java.awt.BasicStroke(0.2f), false},
    {INTERMEDIATE_DEPTH_CONTOUR = 0x24, "Intermediate depth contour", Color.BLUE, new java.awt.BasicStroke(0.2f), false},
    {MAJOR_DEPTH_CONTOUR = 0x25, "Major depth contour", Color.BLUE, new java.awt.BasicStroke(0.5f), false},
    {0x26, "Intermittent stream", water, new java.awt.BasicStroke(1.0f)},
    {0x27, "Airport runway", Color.BLACK, new java.awt.BasicStroke(6.0f)},
    {0x28, "Pipeline", Color.BLUE, new java.awt.BasicStroke(1.0f)},
    {0x29, "Powerline", Color.BLACK, powerLineStroke},
    {0x2a, "Marine boundary", Color.BLUE, new java.awt.BasicStroke(1.0f)},
    {0x2b, "Hazard boundary", Color.RED, new java.awt.BasicStroke(1.0f)},

    //roads or rail in tunnel for Swiss Topo 50
    {TUNNEL_SHIFT + 0x01, "Major highway (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(2.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x02, "Principal highway (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(2.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x03, "Other highway (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(2.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x04, "Arterial road (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(2.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x05, "Collector road (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x06, "Residential street (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x07, "Alley/Private road (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(0.5f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x08, "Highway ramp, low speed (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x09, "Highway ramp, high speed (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x0a, "Unpaved road (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(0.5f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x0b, "Major highway connector (tunnel)", Color.BLACK,
      new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f), true},
    {TUNNEL_SHIFT + 0x0c, "Roundabout (tunnel)", Color.BLACK, new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_BUTT, java.awt.BasicStroke.JOIN_MITER, 10.0f, tinyDash, 0.0f),
      true},
